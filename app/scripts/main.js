...
$(document).ready(function() {
    ...
    oldElement = "";
    allGrid = ["constitGrid", "FAQGrid", "calendarGrid", "photoGrid", "documentGrid", "officerGrid", "songCreedGrid", "contactGrid", "pastTorchGrid", "eastonGrid", "dulaneyGrid", "countryGrid", "loyolaGrid", "eleanorGrid", "certamenGrid", "spellingGrid", "museumGrid", "linganoreGrid", "tshirtsGrid", "fallTorchGrid", "pastOfficerGrid", "winterTorchGrid", "conventionGrid", "springTorchGrid","newOfficersGrid","conventionTorchGrid","minutesGrid"];
    startingNumber = 0;
    setTimeout(function() {
        onHashChange("start");
    }, 500);
...
function changeGridDeep(hashLocation) {
    // console.log("going to "+hashLocation)
    if (hashLocation !== "" && allGrid.indexOf(hashLocation) !== -1) {
        // console.log(hashLocation)
        changeGrid(hashLocation);
...
//         clock.innerText = "Only " + t.days + " days, " + ('0' + t.hours).slice(-2) + " hours, " + ('0' + t.minutes).slice(-2) + " minutes, " + ('0' + t.seconds).slice(-2) + " seconds away";
...
// // var deadline = new Date("April 9 2016");
// var deadline = new Date(1460174400000);
