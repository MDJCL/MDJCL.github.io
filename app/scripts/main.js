...
$(document).ready(function() {
    ...
    oldElement = "";
    allGrid = ["constitGrid", "FAQGrid", "calendarGrid", "photoGrid", "documentGrid", "officerGrid", "songCreedGrid", "contactGrid", "pastTorchGrid", "eastonGrid", "dulaneyGrid", "countryGrid", "loyolaGrid", "eleanorGrid"];
    //run below
    //     a=1;
    // for i in *.png; do
